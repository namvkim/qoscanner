                        ...
                        <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                            ...
                            <TableBody   >
                                ...
                                <TableCell align="center"> 
                                    <Button className={classes.iconCLolor}  type="button"
                                ...
                                <TableCell align="center">
                                    ...
                                    <div 
                                    className={classes.qrcodeHide}
                                    >
                                       <QRCode id={row.id} value={idRestaurent+'/'+row.name} 
                                            size={450}
